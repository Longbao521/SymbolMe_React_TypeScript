...
import photo from './video3D.jpg'

export default function Video3D(): ReactElement {
    return (
        <>
            ...
            行计划，鼓励地球科学和跨学科领域的广泛合作。" title="深时数字地球" copyRight="南京师范大学虚拟环境重点实验室"  src="http://localhost:3001/api/project/video3D"/>
        </>
    )
}
